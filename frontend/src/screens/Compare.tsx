 ...
 * 예적금·펀드는 그대로 더미다). 이 화면이 어디까지 하는지는 <b>약관 정본 제7조</b>가 정한다 —
 * 운영사는 대리·중개 <b>권한이 있으나</b> 그 권한을 행사하지 않고 정보 제공만 한다.
 *
 * <p><b>그래서 신청 버튼을 두지 않는다.</b> 예전에는 '빠른 신청'·'더 알아보기' 두 개가 있었고
 * 더미였을 때는 눌러도 "데모라서 진행되지 않아요"로 끝났다. 약관 정본 제7조가 운영사에게
 * 대리·중개 권한이 있음을 밝히면서도 <b>그 권한을 행사하지 않고 정보 제공만 한다</b>고
 * 함께 밝혔으므로, 이 화면은 <b>혜택 비교까지</b>다. 그 선을 넘길 일이 생기면
 * 약관 제7조를 먼저 보고 정한다 — 화면 주석이 정할 일이 아니다.
 *
