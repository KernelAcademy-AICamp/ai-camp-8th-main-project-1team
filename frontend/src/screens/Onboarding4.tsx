/**
 * 이번 챌린지 정하기 4/4 — 얼마나 줄여볼까요 (프로토타입_0806 `s-ob4`).
 *
 * <p><b>금액이 처음 나오는 화면이다.</b> 앞의 세 화면은 "지난 3개월 이렇게 쓰셨다"(월평균),
 * "안 건드릴 곳", "줄일 곳"만 물었다. 여기서야 <b>한 달에 얼마를 지킬지</b>가 숫자로 나온다 —
 * 고르는 동안 숫자를 들이밀면 사람은 자기 습관이 아니라 표를 고르게 된다.
 *
