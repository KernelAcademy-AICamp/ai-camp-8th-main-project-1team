...
public final class MyDataDtos {
    ...
    /** @param industryCode 가맹점 업종 — 결제 없이도 이 가맹점이 무슨 소비인지 알 수 있게 한다. */
    public record MerchantView(String industryCode, String businessNumber, String merchantName, String address,
