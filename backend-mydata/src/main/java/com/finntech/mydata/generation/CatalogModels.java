...
public final class CatalogModels {
     ...
     *
     * <p><b>{@code industryCode}가 소비 카테고리를 대신한다.</b> 예전에는 여기에 {@code category1}
     ...
     * @param industryCode          KSIC 세분류 4자리. 이 맥락의 결제가 어느 업종에서 일어나는가
    ...
    public record CatalogContext(
            String category2, String industryCode, String channel, String locationType,
