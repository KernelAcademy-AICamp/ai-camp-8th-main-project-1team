...
class CatalogSamplerTest {
    ...
    void merchantProductLocationResolvedFromRealData() {
        ...
        // 업종코드 안에서 맥락 선택 — 국세청 6자리(552101 한식 일반 음식점업).
        String c2 = sampler.pickCategory2("552101", new Random(1));
        assertThat(sampler.context(c2).industryCode()).isEqualTo("552101");
